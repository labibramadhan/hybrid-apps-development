...
exports.store = exports.actions = exports.messages = exports.persistent = undefined;
...
var _rhaboo = require('rhaboo');

var _rhaboo2 = _interopRequireDefault(_rhaboo);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var persistent = exports.persistent = _rhaboo2.default.persistent('todo');
...
var store = exports.store = _reflux2.default.createStore({ //must be constant
    ...
    refresh: function refresh() {
        var self = this;
        _rsConfig.resource.get('/localTodos', { params: { filter: { where: this.where } } }).then(function (res) {
    ...
    onCreate: function onCreate(title) {
        _rsConfig.resource.post('/localTodos', { title: title }).then(function (res) {
    ...
    onToggle: function onToggle(id, completed) {
        _rsConfig.resource.put('/localTodos'.concat('/'.concat(id)), { completed: completed }).then(function (res) {
    ...
    onSetFilter: function onSetFilter(key, value) {
        this.where[key] = value;
        this.refresh();
    },
    onUnsetFilter: function onUnsetFilter(key) {
